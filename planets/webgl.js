...
let numSuns = 1;
let suns = [];
var sunMap,earthMap,venusMap,marsMap,jupiterMap,saturnMap,neptuneMap,uranusMap,plutoMap;
...
function preload(){
    ...
    solarSystem = [marsMap, earthMap, jupiterMap, saturnMap, neptuneMap, uranusMap, plutoMap]
